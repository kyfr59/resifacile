...
class HandleBlocked implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        (new MakeCreateTransaction())->handle(
            transactionData: new TransactionData(
                ...
                error_type: array_key_exists('reason', $transactionData) ? trim($transactionData['reason']['code'] . ' ' . $transactionData['reason']['message'] ?? $transactionData['message']) : $transactionData['message'],
            ),
        );
    }
}
