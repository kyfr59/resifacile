    ...
    <div class="flex flex-col w-full" x-show="showComplement" x-cloak>
        ...
        >
            <input
                ...
                class="w-full border px-3 rounded-[7px] outline-none h-8 placeholder:text-blue-300 @error('address.address_line_3') border-red-500 @else border-blue-300 @enderror"
            />
        </label>
        ...
        >
            <input
                ...
                class="w-full border px-3 rounded-[7px] outline-none h-8 placeholder:text-blue-300 @error('address.address_line_5') border-red-500 @else border-blue-300 @enderror"
            />
        </label>
...
<div class="flex flex-col">
    ...
    <input
        ...
        class="w-full border px-3 rounded-[7px] outline-none h-8 placeholder:text-blue-300 @error('address.postal_code') border-red-500 @else border-blue-300 @enderror"
    />
