<div class="self-start overflow-hidden rounded-[14px] relative bg-pink-500 w-full text-white">
    <img src="/css/sidebar-registered.jpg" class="object-cover max-w-screen-xl w-full h-full absolute z-0 right-0">
    <div class="relative z-10 article-gradient mx-auto p-6 pt-56">
        <div class="flex flex-col gap-3 justify-center w-full max-w-xl">
            <div class="text-2xl text-left">
                Envoyer une <strong>lettre recommandée</strong> en ligne sans contrainte
            </div>
            <div class="text-lg text-left">
                Service disponible 7J/7, 24h/24
            </div>
            <div class="pt-6">
                <a href="{{ route('frontend.landing.registered-letter') }}" class="hover:outline hover:outline-offset-2 hover:outline-4 hover:outline-amber-100 bg-white text-gray-800 h-[4rem] px-6 rounded-[7px] inline-flex items-center justify-start font-semibold leading-tight">
                    Envoyer votre lettre recommandée maintenant
