<div>
    ...
    @else
        @if ($subscriptionIsActive)
            ...
            >
                <div class="w-full md:w-auto bg-red-50 text-center text-red-500 rounded-[7px] p-2 leading-tight text-sm md:text-base">Vous ne bénéficierez plus des avantages Accès+ !</div>
                    <div>
