<form wire:submit.prevent="save" class="grid grid-cols-1">
                        ...
                        <div class="flex-none flex justify-end">
                            <div class="flex items-center justify-end">
                                <div class="font-light cursor-pointer inline-flex items-center">
                                    <input type="checkbox" wire:model.live="typeAddress" id="type_address" class="toggle-checkbox"/>
                                </div>
                            </div>
                        </div>
                        <div class="flex flex-col gap-1 items-start justify-start md:justify-center flex-auto">
                            <div class="flex-auto leading-tight text-blue-700">Je suis <strong>un professionnel</strong></div>
                        </div>
                    </label>
                    @if(!$loop->first)
                        <div class="flex justify-end">
                            <button
                                ...
                                class="w-8 h-14 md:h-8 text-blue-700 cursor-pointer flex items-center justify-center text-xs bg-white border border-b-[3px] border-gray-300 rounded-sm"
                            >
    ...
    <div class="pt-6 flex flex-col">
        <div class="pb-6 flex flex-col-reverse sm:flex-row gap-6 justify-between">
            <a
                href="{{ route('frontend.letter.recipient') }}"
