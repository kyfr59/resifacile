        ...
        <section class="bg-gray-50">
            <div class="grid grid-cols-1 gap-3 md:gap-6 w-full max-w-screen-lg mx-auto py-12 md:py-24 px-6">
                ...
                <div class="text-[.7rem] text-justify">
                    ...
                    Pour obtenir davantage d'informations sur la protection de vos données personnelles, les traitements effectués par Kolibri Network SAS, ainsi que les démarches pour exercer vos droits, veuillez consulter notre <a href="{{ route('pages.content', ['page' => 'grpd']) }}">politique de confidentialité</a>.
                </div>
            </div>
        </section>
    </div>
