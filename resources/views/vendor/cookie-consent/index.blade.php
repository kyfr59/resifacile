...
<div
    ...
    aria-modal="true"
    class="lcc-modal lcc-modal--alert lcc-banner js-lcc-modal js-lcc-modal-alert"
    style="display: none"
...
>
    <div class="lcc-banner__inner">
        <div class="lcc-modal__content lcc-banner__text">
        ...
        <div class="lcc-modal__actions lcc-banner__actions">
            <button type="button" class="lcc-button lcc-button--ghost js-lcc-settings-toggle">
                @lang('cookie-consent::texts.alert_settings')
            </button>
            <button type="button" class="lcc-button lcc-button--secondary js-lcc-essentials">
